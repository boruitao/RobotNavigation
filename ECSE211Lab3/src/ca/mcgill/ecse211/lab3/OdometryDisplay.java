 ...
 * @version 1.0
 *  This class is used to print information to the screen.
 */
...
public class OdometryDisplay extends Thread {
	...
	/**
	 * This method displays information on the robot's screen.
	 * @param x used to format spacing
	 * @param places counter for decimal
	 */
